...
#ThreeBrothers #Futebol #Camisetas #Exclusivo`,
          files: [arquivo]
        };
  ...
  return (
    <div className="page-container">
      <div className="page-content">
        ...
        <h1 className="page-title" style={{marginTop: '0px', marginBottom: '5px', fontSize: '1.8rem'}}>Futebol</h1>
        <p className="page-description" style={{marginTop: '0px', marginBottom: '15px', fontSize: '0.9rem'}}>
          Confira as camisetas de futebol disponíveis em nossa coleção!
        </p>
