  ...
  const camisetas = [
    {
      id: 1,
      nome: "Modelo Dragão",
      url: "https://res.cloudinary.com/dx8lkbjpl/image/upload/v1754259845/Modelo_drag%C3%A3o_iu1wbd.png"
    },
    {
      id: 2,
      nome: "Modelo Águia",
      url: "https://res.cloudinary.com/dx8lkbjpl/image/upload/v1754259843/Modelo_aguia_jzb937.png"
    }
...
#ThreeBrothers #Basquete #Camisetas #Exclusivo`,
          files: [arquivo]
        };
  ...
  return (
    <div className="page-container">
      <div className="page-content">
        ...
        <h1 className="page-title" style={{marginTop: '0px', marginBottom: '5px', fontSize: '1.8rem'}}>Basquete</h1>
        <p className="page-description" style={{marginTop: '0px', marginBottom: '15px', fontSize: '0.9rem'}}>
          Confira as camisetas de basquete disponíveis em nossa coleção!
        </p>
